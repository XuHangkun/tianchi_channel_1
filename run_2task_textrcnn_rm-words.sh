...
python ./code/train.py -model TextRCNN_task1 -model_task 1 -epoch ${train_epoch} -seed 7 -no_word2vec_pretrain -fold_index -1 \
...
############ TRAIN ################
# 5-fold train TextRCNN
python ./code/train.py -model TextRCNN_task2 -model_task 2 -epoch ${train_epoch} -seed 7 -no_word2vec_pretrain -fold_index -1 \
-output_dir ./user_data/model_data/TextRCNN -lr 5.e-4 -input ./tcdata/train.csv \
-dropout 0.5 -nemb 100 -max_len 100 -hidden_size 1024 -lstm_dropout 0.1 \
-eda_alpha 0.1 -n_aug 4.0
