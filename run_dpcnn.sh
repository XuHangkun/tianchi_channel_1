...
python ./code/train.py -model DPCNN -epoch 30 -no_word2vec_pretrain -seed 7 \
-output_dir ./user_data/model_data/DPCNN -lr 1.e-3 -input ./tcdata/train.csv
...
-models DPCNN/DPCNN_fold1 DPCNN/DPCNN_fold2 DPCNN/DPCNN_fold3 DPCNN/DPCNN_fold4 DPCNN/DPCNN_fold5 \
-model_path ./user_data/model_data \
-output ./result.csv
